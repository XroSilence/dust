...
const Areas = lazy(() => import('./pages/areas/Areas.js'));
const AdminLogin = lazy(() => import('./pages/admin/AdminLogin.js'));
const AdminDashboard = lazy(() => import('./pages/admin/AdminDashboard.js'));
const SetupTwoFactor = lazy(() => import('./pages/admin/SetupTwoFactor.js'));
